...
import static org.optaplanner.examples.taskassigning_listvariable.persistence.TaskAssigningGenerator.BASE_DURATION_AVERAGE;
...
public class TaskAssigningPanel extends SolutionPanel<TaskAssigningSolution> {
    ...
    public static final String LOGO_PATH = "/org/optaplanner/examples/taskassigning_listvariable/swingui/taskAssigningLogo.png";
