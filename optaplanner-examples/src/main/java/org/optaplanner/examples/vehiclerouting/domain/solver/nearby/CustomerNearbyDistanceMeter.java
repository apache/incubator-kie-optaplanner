...
public class CustomerNearbyDistanceMeter implements NearbyDistanceMeter<Customer, Location> {

    @Override
    public double getNearbyDistance(Customer origin, Location destination) {
        long distance = origin.getLocation().getDistanceTo(destination);
