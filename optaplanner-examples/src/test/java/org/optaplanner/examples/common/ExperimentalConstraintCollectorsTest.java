...
public class ExperimentalConstraintCollectorsTest {
    ...
    public void consecutiveInterval() {
        // Do a basic test w/o edge cases; edge cases are covered in
        // ConsecutiveSetTreeTest
        UniConstraintCollector<Interval, ?, ConsecutiveIntervalData<Interval, Integer>> collector =
    ...
    private ConsecutiveIntervalData<Interval, Integer> consecutiveIntervalData(Interval... data) {
