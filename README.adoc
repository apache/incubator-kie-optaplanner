...
=== Benchmarking core
If you want to benchmark performance of `optaplanner-core` module, simply build it with benchmarking profile activated.
Example of usage:
....
cd optaplanner-core
mvn clean install -P benchmark
java -jar target/optaplanner-core-{VERSION}-benchmarks.jar
....
