...
* **Vehicle routing**: planning vehicle routes (trucks, trains, boats, airplanes, ...) for moving freight and/or passengers through multiple destinations ...
...
//I propose removing this image and replacing it with the following paragraph.
...
// This image is redundant in the documentation. The steps to download, unzip and open are simple and clearly explained.
