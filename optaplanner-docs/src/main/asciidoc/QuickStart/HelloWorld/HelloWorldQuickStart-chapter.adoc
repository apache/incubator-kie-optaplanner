...
* A <<logging,logging>> implementation, such as `logback-classic` (runtime scope), to see what OptaPlanner is doing.
...
include::../SchoolTimetabling/SchoolTimetablingModel-section.adoc[leveloffset=+1]
include::../SchoolTimetabling/SchoolTimetablingConstraints-section.adoc[leveloffset=+1]
include::../SchoolTimetabling/SchoolTimetablingSolution-section.adoc[leveloffset=+1]
...
and the `ContraintProvider` class, all of which you created earlier.
