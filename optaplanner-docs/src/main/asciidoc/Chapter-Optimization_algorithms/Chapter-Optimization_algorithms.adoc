...
The _best_ optimization algorithms configuration to use depends heavily on your use case.
Nevertheless, this vanilla recipe will get you into the game with a pretty good configuration.
