...
include::IntroductionToRepeatedPlanning/IntroductionToRepeatedPlanning-section.adoc[leveloffset=+1]

include::BackupPlanning/BackupPlanning-section.adoc[leveloffset=+1]

include::OverconstrainedPlanning/OverconstrainedPlanning-section.adoc[leveloffset=+1]
