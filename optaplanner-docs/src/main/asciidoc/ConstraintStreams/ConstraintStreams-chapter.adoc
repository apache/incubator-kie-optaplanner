...
We recommend using one of the myriad freely available 3rd party implementations.
...
When designing the mapping function, we recommend you follow these guidelines for optimal performance:
