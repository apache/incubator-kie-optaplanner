...
[WARNING]
====
For the ConstraintStreams API, <<explainingTheScore,Constraint justifications>> may not function properly yet.
====
...
Using Java's Streams API, we could implement an <<easyJavaScoreCalculation,easy score calculator>>
