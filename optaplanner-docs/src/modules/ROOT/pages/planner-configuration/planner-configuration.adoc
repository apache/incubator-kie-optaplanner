...
Use a <<chainedPlanningVariable,chained planning variable>> instead of a list planning variable, if you need any of the following planning techniques:
...
- xref:exhaustive-search/exhaustive-search.adoc[exhaustive search],
- xref:partitioned-search/partitioned-search.adoc[partitioned search],
