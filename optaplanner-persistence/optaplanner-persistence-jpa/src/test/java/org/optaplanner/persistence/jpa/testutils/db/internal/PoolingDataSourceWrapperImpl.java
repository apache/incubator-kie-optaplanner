...
package org.optaplanner.persistence.jpa.testutils.db.internal;
...
import org.optaplanner.persistence.jpa.testutils.db.PoolingDataSourceWrapper;
...
public final class PoolingDataSourceWrapperImpl implements PoolingDataSourceWrapper {
    ...
    public PoolingDataSourceWrapperImpl(final String uniqueName,
        ...
        managedDataSource = (BasicManagedDataSource) PoolingDataSourceFactory.createPoolingDataSource(tm, xaDataSource, tsr,
                sanitizedPoolingProperties);
    ...
    private XADataSource createXaDataSource() {
        ...
        if (databaseProvider != DatabaseProvider.DB2 && databaseProvider != DatabaseProvider.SYBASE) {
            ...
            if (databaseProvider == DatabaseProvider.DB2) {
                ...
                invokeMethodOnXADataSource(xaDataSource, "setPortNumber",
                        Integer.parseInt(driverProperties.getProperty("portNumber")), int.class);
                invokeMethodOnXADataSource(xaDataSource, "setResultSetHoldability",
                        Integer.parseInt(driverProperties.getProperty("ResultSetHoldability")), int.class);
                invokeMethodOnXADataSource(xaDataSource, "setDowngradeHoldCursorsUnderXa",
                        Boolean.parseBoolean(driverProperties.getProperty("DowngradeHoldCursorsUnderXa")), boolean.class);
