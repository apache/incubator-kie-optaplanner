...
package org.optaplanner.persistence.jpa.testutils.db;

import java.util.Properties;

import org.apache.tomcat.dbcp.dbcp2.managed.BasicManagedDataSource;
import org.optaplanner.persistence.jpa.testutils.db.internal.DatabaseProvider;
import org.optaplanner.persistence.jpa.testutils.db.internal.PoolingDataSourceWrapperImpl;

/**
 * Creates instances of {@link org.optaplanner.persistence.jpa.testutils.db.PoolingDataSourceWrapper} that can be used for
 * testing purposes.
 */
public final class DataSourceFactory {
    ...
    /**
     * Creates a new instance of {@link org.optaplanner.persistence.jpa.testutils.db.PoolingDataSourceWrapper}.
     * 
     ...
     */
    public static org.optaplanner.persistence.jpa.testutils.db.PoolingDataSourceWrapper setupPoolingDataSource(
    ...
    public static PoolingDataSourceWrapper setupPoolingDataSource(String datasourceName,
        ...
        return new PoolingDataSourceWrapperImpl(datasourceName, xaDataSourceClassName, sanitizedDriverProperties,
                poolingProperties);
    }
}
