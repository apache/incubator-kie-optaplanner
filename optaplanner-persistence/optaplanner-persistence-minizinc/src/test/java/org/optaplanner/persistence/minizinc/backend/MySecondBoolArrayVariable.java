...
@PlanningEntity
public class MySecondBoolArrayVariable implements BoolArrayVariable {
    ...
    public MySecondBoolArrayVariable() {
    }

    public MySecondBoolArrayVariable(int index, boolean value) {
