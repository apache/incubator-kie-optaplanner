...
@PlanningEntity
public class MySecondIntSetVariable implements IntSetVariable {

    @PlanningVariable(valueRangeProviderRefs = { "intSetValueRange" })
    IntSet value;

    public MySecondIntSetVariable() {
        this(new IntSet());
    }

    public MySecondIntSetVariable(int... values) {
        this(new IntSet(values));
    }

    public MySecondIntSetVariable(IntSet value) {
        this.value = value;
    }
