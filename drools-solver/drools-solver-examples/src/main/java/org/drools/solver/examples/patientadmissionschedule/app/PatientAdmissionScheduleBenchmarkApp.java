...
public class PatientAdmissionScheduleBenchmarkApp extends CommonBenchmarkApp {
    ...
    public static final String DEFAULT_SOLVER_BENCHMARK_CONFIG
            = "/org/drools/solver/examples/patientadmissionschedule/benchmark/patientAdmissionScheduleSolverBenchmarkConfig.xml";
    public static final String SHORT_SOLVER_BENCHMARK_CONFIG
            = "/org/drools/solver/examples/patientadmissionschedule/benchmark/patientAdmissionScheduleShortSolverBenchmarkConfig.xml";
