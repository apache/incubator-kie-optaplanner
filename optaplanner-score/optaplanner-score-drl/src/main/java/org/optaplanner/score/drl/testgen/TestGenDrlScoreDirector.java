 ...
 */
package org.optaplanner.score.drl.testgen;
...
import org.optaplanner.score.drl.DrlScoreDirector;
import org.optaplanner.score.drl.DrlScoreDirectorFactory;
import org.optaplanner.score.drl.holder.AbstractScoreHolder;
import org.optaplanner.score.drl.testgen.reproducer.TestGenCorruptedScoreException;
import org.optaplanner.score.drl.testgen.reproducer.TestGenCorruptedScoreReproducer;
import org.optaplanner.score.drl.testgen.reproducer.TestGenCorruptedVariableListenerReproducer;
import org.optaplanner.score.drl.testgen.reproducer.TestGenDroolsExceptionReproducer;
...
public class TestGenDrlScoreDirector<Solution_, Score_ extends Score<Score_>>
    ...
    public TestGenDrlScoreDirector(DrlScoreDirectorFactory<Solution_, Score_> scoreDirectorFactory,
    ...
    public KieSession createKieSession() {
        ...
        if (scoreDefinition != null) {
            ...
            newKieSession.setGlobal(DrlScoreDirector.GLOBAL_SCORE_HOLDER_KEY, sh);
        }
