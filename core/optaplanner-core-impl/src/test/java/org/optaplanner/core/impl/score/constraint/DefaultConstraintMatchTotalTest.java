...
import static org.optaplanner.core.impl.score.constraint.DefaultIndictment.getDefaultIndictmentMapping;
...
class DefaultConstraintMatchTotalTest {
    ...
    void getScoreTotal() {
        ...
        ConstraintMatch<SimpleScore> match1 =
                constraintMatchTotal.addConstraintMatch(of(e1, e2), getDefaultIndictmentMapping(e1, e2), SimpleScore.of(-1));
        assertThat(constraintMatchTotal.getScore()).isEqualTo(SimpleScore.of(-1));
        ConstraintMatch<SimpleScore> match2 =
                constraintMatchTotal.addConstraintMatch(of(e1, e3), getDefaultIndictmentMapping(e1, e3), SimpleScore.of(-20));
        ...
        ConstraintMatch<SimpleScore> match3 =
                constraintMatchTotal.addConstraintMatch(of(e2, e1), getDefaultIndictmentMapping(e2, e1), SimpleScore.of(-300));
