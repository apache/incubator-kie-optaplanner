...
abstract class BavetAbstractBiGroupBridgeQuadConstraintStream<Solution_, A, B, C, D, NewA, NewB>
    ...
    public BavetAbstractBiGroupBridgeQuadConstraintStream(BavetConstraintFactory<Solution_> constraintFactory,
    ...
    public final <Score_ extends Score<Score_>> void buildNode(NodeBuildHelper<Score_> buildHelper) {
        ...
        AbstractGroupNode<QuadTuple<A, B, C, D>, BiTuple<NewA, NewB>, ?, ?> node =
                createNode(inputStoreIndex, insert, retract, outputStoreSize);
        buildHelper.addNode(node);
        buildHelper.putInsertRetract(this, node::insert, node::retract);
    }

    protected abstract AbstractGroupQuadNode<A, B, C, D, BiTuple<NewA, NewB>, ?, ?, ?> createNode(int inputStoreIndex,
