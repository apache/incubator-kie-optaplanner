...
final class BavetGroupBridge0Mapping3CollectorQuadConstraintStream<Solution_, A, B, C, D, ResultContainerA_, NewA, ResultContainerB_, NewB, ResultContainerC_, NewC>
    ...
    public BavetGroupBridge0Mapping3CollectorQuadConstraintStream(BavetConstraintFactory<Solution_> constraintFactory,
    ...
    protected AbstractGroupQuadNode<A, B, C, D, TriTuple<NewA, NewB, NewC>, ?, ?, ?> createNode(int inputStoreIndex,
        ...
        return new Group0Mapping3CollectorQuadNode<>(inputStoreIndex,
