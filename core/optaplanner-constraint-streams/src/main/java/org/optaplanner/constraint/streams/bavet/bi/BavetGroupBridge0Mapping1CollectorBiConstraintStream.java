...
final class BavetGroupBridge0Mapping1CollectorBiConstraintStream<Solution_, A, B, ResultContainer_, NewA>
    ...
    @Override
    protected AbstractGroupBiNode<A, B, UniTuple<NewA>, ?, ?, ?> createNode(int inputStoreIndex, Consumer<UniTuple<NewA>> insert, Consumer<UniTuple<NewA>> retract, int outputStoreSize) {
