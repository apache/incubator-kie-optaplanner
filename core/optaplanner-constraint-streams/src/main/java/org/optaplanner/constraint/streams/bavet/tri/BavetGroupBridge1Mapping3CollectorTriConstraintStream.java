...
final class BavetGroupBridge1Mapping3CollectorTriConstraintStream<Solution_, A, B, C, NewA, ResultContainerB_, NewB, ResultContainerC_, NewC, ResultContainerD_, NewD>
    ...
    public BavetGroupBridge1Mapping3CollectorTriConstraintStream(BavetConstraintFactory<Solution_> constraintFactory,
    ...
    protected AbstractGroupTriNode<A, B, C, QuadTuple<NewA, NewB, NewC, NewD>, ?, ?, ?> createNode(int inputStoreIndex,
            ...
            int outputStoreSize) {
        return new Group1Mapping3CollectorTriNode<>(groupKeyMapping, inputStoreIndex, collectorB, collectorC, collectorD,
