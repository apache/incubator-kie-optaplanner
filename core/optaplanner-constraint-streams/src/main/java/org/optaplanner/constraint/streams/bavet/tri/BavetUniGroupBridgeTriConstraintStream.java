...
final class BavetUniGroupBridgeTriConstraintStream<Solution_, A, B, C, NewA>
    ...
    private final TriNodeConstructor<A, B, C, UniTuple<NewA>> nodeConstructor;

    public BavetUniGroupBridgeTriConstraintStream(BavetConstraintFactory<Solution_> constraintFactory,
            BavetAbstractTriConstraintStream<Solution_, A, B, C> parent,
            TriNodeConstructor<A, B, C, UniTuple<NewA>> nodeConstructor) {
    ...
    public final <Score_ extends Score<Score_>> void buildNode(NodeBuildHelper<Score_> buildHelper) {
        ...
        AbstractGroupNode<TriTuple<A, B, C>, UniTuple<NewA>, ?, ?> node = nodeConstructor.apply(inputStoreIndex,
