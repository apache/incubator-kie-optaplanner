...
final class BavetGroupBridge1Mapping3CollectorUniConstraintStream<Solution_, A, NewA, ResultContainerB_, NewB, ResultContainerC_, NewC, ResultContainerD_, NewD>
    ...
    public BavetGroupBridge1Mapping3CollectorUniConstraintStream(BavetConstraintFactory<Solution_> constraintFactory,
    ...
    protected AbstractGroupUniNode<A, QuadTuple<NewA, NewB, NewC, NewD>, ?, ?, ?> createNode(int inputStoreIndex,
            ...
            int outputStoreSize) {
        return new Group1Mapping3CollectorUniNode<>(groupKeyMapping, inputStoreIndex, collectorB, collectorC, collectorD,
