...
abstract class BavetAbstractQuadGroupBridgeUniConstraintStream<Solution_, A, NewA, NewB, NewC, NewD>
    ...
    public BavetAbstractQuadGroupBridgeUniConstraintStream(BavetConstraintFactory<Solution_> constraintFactory,
    ...
    protected abstract AbstractGroupUniNode<A, QuadTuple<NewA, NewB, NewC, NewD>, ?, ?, ?> createNode(
            int inputStoreIndex,
