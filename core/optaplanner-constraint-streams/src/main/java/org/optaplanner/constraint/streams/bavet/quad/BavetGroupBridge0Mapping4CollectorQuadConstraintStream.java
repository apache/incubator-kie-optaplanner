...
final class BavetGroupBridge0Mapping4CollectorQuadConstraintStream<Solution_, A, B, C, D, ResultContainerA_, NewA, ResultContainerB_, NewB, ResultContainerC_, NewC, ResultContainerD_, NewD>
        extends BavetAbstractQuadGroupBridgeQuadConstraintStream<Solution_, A, B, C, D, NewA, NewB, NewC, NewD> {

    private final QuadConstraintCollector<A, B, C, D, ResultContainerA_, NewA> collectorA;
    ...
    public BavetGroupBridge0Mapping4CollectorQuadConstraintStream(BavetConstraintFactory<Solution_> constraintFactory,
            BavetAbstractQuadConstraintStream<Solution_, A, B, C, D> parent,
            QuadConstraintCollector<A, B, C, D, ResultContainerA_, NewA> collectorA,
    ...
    protected AbstractGroupQuadNode<A, B, C, D, QuadTuple<NewA, NewB, NewC, NewD>, ?, ?, ?> createNode(int inputStoreIndex,
            ...
            int outputStoreSize) {
        return new Group0Mapping4CollectorQuadNode<>(inputStoreIndex, collectorA, collectorB, collectorC, collectorD,
