...
abstract class BavetAbstractTriGroupBridgeQuadConstraintStream<Solution_, A, B, C, D, NewA, NewB, NewC>
    ...
    public BavetAbstractTriGroupBridgeQuadConstraintStream(BavetConstraintFactory<Solution_> constraintFactory,
    ...
    protected abstract AbstractGroupQuadNode<A, B, C, D, TriTuple<NewA, NewB, NewC>, ?, ?, ?> createNode(
            int inputStoreIndex,
