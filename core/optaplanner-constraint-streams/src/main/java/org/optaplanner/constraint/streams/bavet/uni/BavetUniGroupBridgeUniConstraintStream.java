...
final class BavetUniGroupBridgeUniConstraintStream<Solution_, A, NewA>
    ...
    private final UniNodeConstructor<A, UniTuple<NewA>> nodeConstructor;

    public BavetUniGroupBridgeUniConstraintStream(BavetConstraintFactory<Solution_> constraintFactory,
            BavetAbstractUniConstraintStream<Solution_, A> parent,
            UniNodeConstructor<A, UniTuple<NewA>> nodeConstructor) {
    ...
    public final <Score_ extends Score<Score_>> void buildNode(NodeBuildHelper<Score_> buildHelper) {
        ...
        AbstractGroupNode<UniTuple<A>, UniTuple<NewA>, ?, ?> node = nodeConstructor.apply(inputStoreIndex,
