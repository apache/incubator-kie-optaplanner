...
abstract class BavetAbstractTriGroupBridgeTriConstraintStream<Solution_, A, B, C, NewA, NewB, NewC>
    ...
    public BavetAbstractTriGroupBridgeTriConstraintStream(BavetConstraintFactory<Solution_> constraintFactory,
    ...
    protected abstract AbstractGroupTriNode<A, B, C, TriTuple<NewA, NewB, NewC>, ?, ?, ?> createNode(int inputStoreIndex,
