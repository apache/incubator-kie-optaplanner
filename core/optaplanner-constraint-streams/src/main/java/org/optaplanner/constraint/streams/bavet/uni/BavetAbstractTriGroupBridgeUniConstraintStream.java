...
abstract class BavetAbstractTriGroupBridgeUniConstraintStream<Solution_, A, NewA, NewB, NewC>
    ...
    public BavetAbstractTriGroupBridgeUniConstraintStream(BavetConstraintFactory<Solution_> constraintFactory,
    ...
    public final <Score_ extends Score<Score_>> void buildNode(NodeBuildHelper<Score_> buildHelper) {
        ...
        AbstractGroupUniNode<A, TriTuple<NewA, NewB, NewC>, ?, ?, ?> node =
    ...
    protected abstract AbstractGroupUniNode<A, TriTuple<NewA, NewB, NewC>, ?, ?, ?> createNode(int inputStoreIndex,
