...
final class BavetGroupBridge4Mapping0CollectorBiConstraintStream<Solution_, A, B, NewA, NewB, NewC, NewD>
    ...
    private final BiFunction<A, B, NewD> groupKeyMappingD;

    public BavetGroupBridge4Mapping0CollectorBiConstraintStream(BavetConstraintFactory<Solution_> constraintFactory,
            BavetAbstractBiConstraintStream<Solution_, A, B> parent,
            BiFunction<A, B, NewA> groupKeyMappingA, BiFunction<A, B, NewB> groupKeyMappingB,
            BiFunction<A, B, NewC> groupKeyMappingC, BiFunction<A, B, NewD> groupKeyMappingD) {
    ...
    protected AbstractGroupBiNode<A, B, QuadTuple<NewA, NewB, NewC, NewD>, ?, ?, ?> createNode(int inputStoreIndex,
            ...
            int outputStoreSize) {
        return new Group4Mapping0CollectorBiNode<>(
