...
abstract class BavetAbstractUniGroupBridgeTriConstraintStream<Solution_, A, B, C, NewA>
    ...
    public BavetAbstractUniGroupBridgeTriConstraintStream(BavetConstraintFactory<Solution_> constraintFactory,
    ...
    protected abstract AbstractGroupTriNode<A, B, C, UniTuple<NewA>, ?, ?, ?> createNode(int inputStoreIndex,
