...
final class BavetGroupBridge0Mapping4CollectorUniConstraintStream<Solution_, A, ResultContainerA_, NewA, ResultContainerB_, NewB, ResultContainerC_, NewC, ResultContainerD_, NewD>
    ...
    public BavetGroupBridge0Mapping4CollectorUniConstraintStream(BavetConstraintFactory<Solution_> constraintFactory,
    ...
    protected AbstractGroupUniNode<A, QuadTuple<NewA, NewB, NewC, NewD>, ?, ?, ?> createNode(int inputStoreIndex,
            ...
            int outputStoreSize) {
        return new Group0Mapping4CollectorUniNode<>(inputStoreIndex, collectorA, collectorB, collectorC, collectorD,
