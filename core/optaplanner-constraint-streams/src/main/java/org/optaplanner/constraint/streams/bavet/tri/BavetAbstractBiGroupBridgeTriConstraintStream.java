...
abstract class BavetAbstractBiGroupBridgeTriConstraintStream<Solution_, A, B, C, NewA, NewB>
    ...
    public BavetAbstractBiGroupBridgeTriConstraintStream(BavetConstraintFactory<Solution_> constraintFactory,
    ...
    protected abstract AbstractGroupTriNode<A, B, C, BiTuple<NewA, NewB>, ?, ?, ?> createNode(int inputStoreIndex,
