...
final class BavetGroupBridge3Mapping1CollectorBiConstraintStream<Solution_, A, B, NewA, NewB, NewC, ResultContainer_, NewD>
    ...
    private final BiConstraintCollector<A, B, ResultContainer_, NewD> collector;

    public BavetGroupBridge3Mapping1CollectorBiConstraintStream(BavetConstraintFactory<Solution_> constraintFactory,
            BavetAbstractBiConstraintStream<Solution_, A, B> parent, BiFunction<A, B, NewA> groupKeyMappingA,
            BiFunction<A, B, NewB> groupKeyMappingB, BiFunction<A, B, NewC> groupKeyMappingC,
            BiConstraintCollector<A, B, ResultContainer_, NewD> collector) {
    ...
    protected AbstractGroupBiNode<A, B, QuadTuple<NewA, NewB, NewC, NewD>, ?, ?, ?> createNode(int inputStoreIndex,
            ...
            int outputStoreSize) {
        return new Group3Mapping1CollectorBiNode<>(groupKeyMappingA, groupKeyMappingB, groupKeyMappingC, inputStoreIndex,
