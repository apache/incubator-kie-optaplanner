...
final class BavetGroupBridge1Mapping0CollectorQuadConstraintStream<Solution_, A, B, C, D, NewA>
    ...
    public BavetGroupBridge1Mapping0CollectorQuadConstraintStream(BavetConstraintFactory<Solution_> constraintFactory,
    ...
    protected AbstractGroupQuadNode<A, B, C, D, UniTuple<NewA>, ?, ?, ?> createNode(int inputStoreIndex,
        ...
        return new Group1Mapping0CollectorQuadNode<>(groupKeyMapping, inputStoreIndex, insert, retract, outputStoreSize);
    }
}
