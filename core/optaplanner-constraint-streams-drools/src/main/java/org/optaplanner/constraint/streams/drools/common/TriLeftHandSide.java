...
public final class TriLeftHandSide<A, B, C> extends AbstractLeftHandSide {
    ...
    private ViewItem<?> buildGroupBy(AccumulateFunction... accFunctions) {
        ...
        return buildGroupBy(groupKey, (a, b, c) -> SINGLETON_GROUP_KEY, accFunctions);
    }
