        ...
        InnerScoreDirector<TestdataLavishSolution, SimpleScore> scoreDirector = buildScoreDirector(
                ...
                factory -> {
                    ...
                    return new Constraint[] {
                            base.penalize(SimpleScore.ONE).as("myConstraint1"),
                            base.penalize(SimpleScore.ONE).as("myConstraint2")
                    };
                });
