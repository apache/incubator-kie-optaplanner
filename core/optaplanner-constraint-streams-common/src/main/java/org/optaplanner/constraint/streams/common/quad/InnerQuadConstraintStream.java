...
public interface InnerQuadConstraintStream<A, B, C, D> extends QuadConstraintStream<A, B, C, D> {
    ...
    static <A, B, C, D> PentaFunction<A, B, C, D, Score<?>, DefaultConstraintJustification> newDefaultJustificationMapping() {
        return (a, b, c, d, score) -> DefaultConstraintJustification.of(score, a, b, c, d);
    }

    static <A, B, C, D> QuadFunction<A, B, C, D, Collection<?>> newDefaultIndictedObjectsMapping() {
        return List::of;
    }
