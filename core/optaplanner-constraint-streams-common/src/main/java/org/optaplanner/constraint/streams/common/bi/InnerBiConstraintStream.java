...
public interface InnerBiConstraintStream<A, B> extends BiConstraintStream<A, B> {
    ...
    static <A, B> TriFunction<A, B, Score<?>, DefaultConstraintJustification> newDefaultJustificationMapping() {
        return (a, b, score) -> DefaultConstraintJustification.of(score, a, b);
    }

    static <A, B> BiFunction<A, B, Collection<?>> newDefaultIndictedObjectsMapping() {
        return List::of;
    }
