...
public interface InnerTriConstraintStream<A, B, C> extends TriConstraintStream<A, B, C> {
    ...
    static <A, B, C> QuadFunction<A, B, C, Score<?>, DefaultConstraintJustification> newDefaultJustificationMapping() {
        return (a, b, c, score) -> DefaultConstraintJustification.of(score, a, b, c);
    }

    static <A, B, C> TriFunction<A, B, C, Collection<?>> newDefaultIndictedObjectsMapping() {
        return List::of;
    }
