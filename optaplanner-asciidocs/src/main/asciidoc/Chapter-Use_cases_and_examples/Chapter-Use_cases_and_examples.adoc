...
|<<_cloudbalancing,Cloud balancing>>
|
...
* <<_realtimeplanning,Real-time planning>>
...
* <<_fairnessscoreconstraints,Fairness score constraints>>
* <<_immovableplanningentities,Immovable entities>>
...
* <<_timegrainpattern,TimeGrain pattern>>
...
* <<_shadowvariable,Shadow variable>>
* <<_realtimeplanning,Real-time planning>>
* <<_nearbyselection,Nearby selection>>
* Real road distances
...
* Custom <<_customvariablelistener,VariableListener>>


|<<_projectjobscheduling,
...
* <<_bendablescore,Bendable score>>
* Custom <<_customvariablelistener,VariableListener>>
* <<_valuerangefactory,ValueRangeFactory>>
...
* <<_overconstrainedplanning,Overconstrained planning>>
...
* <<_bendablescore,Bendable score>>
* <<_chainedthroughtimepattern,Chained through time pattern>>
* Custom <<_customvariablelistener,VariableListener>>
* <<_continuousplanning,Continuous planning>>
* <<_realtimeplanning,Real-time planning>>
...
* Custom <<_movelistfactory,MoveListFactory>>


|<<_cheaptimescheduling,
...
* <<_annotationalternatives,Field annotations>>
* <<_valuerangefactory,ValueRangeFactory>>
...
A _realistic competition_ is **an official, independent
    competition**:
...
This example is explained in <<_cloudbalancingtutorial,a tutorial>>.

[[_tsp]]
=== Traveling Salesman (TSP - Traveling Salesman Problem)

[[_tspproblemdescription]]
==== Problem Description
...
[[_dinnerpartyproblemdescription]]
==== Problem Description
...
[[_meetingschedulingproblemdescription]]
==== Problem Description
...
[[_curriculumcourseproblemdescription]]
==== Problem Description
...
The problem is defined by http://www.cs.qub.ac.uk/itc2007/curriculmcourse/course_curriculm_index.htm[the International
        Timetabling Competition 2007 track 3].

[[_curriculumcourseproblemsize]]
==== Problem Size
...
[[_machinereassignmentproblemdescription]]
==== Problem Description
...
The problem is defined by http://challenge.roadef.org/2012/en/[the Google ROADEF/EURO
        Challenge 2012].

[[_machinereassignmentvalueproposition]]
==== Value Proposition


See <<_cloudbalancingvalueproposition,the Cloud Balancing value proposition>>.

[[_machinereassignmentproblemsize]]
==== Problem Size
...
[[_machinereassignmentdomainmodel]]
==== Domain Model
...
[[_vehicleroutingproblemdescription]]
==== Problem Description
...
[[_vehicleroutingvalueproposition]]
==== Value Proposition
...
The vehicle routing with timewindows domain model makes heavily use of <<_shadowvariable,shadow variables>>.
...
[[_roaddistancesinsteadofairdistances]]
...
There are several technologies available to precalculate road costs, such as https://graphhopper.com/[GraphHopper] (embeddable, offline Java engine), http://open.mapquestapi.com/directions/#matrix[Open MapQuest] (web service) and https://developers.google.com/maps/documentation/webservices/client-library[Google Maps Client
        API] (web service).
...
[[_projectjobschedulingproblemdescription]]
==== Problem Description
...
The problem is defined by http://gent.cs.kuleuven.be/mista2013challenge/[the MISTA 2013
        challenge].

[[_projectjobschedulingproblemsize]]
==== Problem Size
...
[[_bedallocationproblemdescription]]
==== Problem Description
...
This problem features <<_overconstrainedplanning,overconstrained>> datasets.
...
[[_taskassigningproblemdescription]]
==== Problem Description
...
** Start with the longest working employee first, then the second longest working employee and so forth, to creates <<_fairnessscoreconstraints,fairness and load balancing>>.
...
[[_examinationproblemdescription]]
==== Problem Description
...
The problem is defined by http://www.cs.qub.ac.uk/itc2007/examtrack/exam_track_index.htm[the International Timetabling
        Competition 2007 track 1].
...
[[_employeerosteringproblemdescription]]
==== Problem Description
...
The problem is defined by http://www.kuleuven-kortrijk.be/nrpcompetition[the
        International Nurse Rostering Competition 2010].

[[_employeerosteringvalueproposition]]
==== Value Proposition
...
[[_travelingtournamentproblemdescription]]
==== Problem Description
...
The problem is defined on http://mat.gsia.cmu.edu/TOURN/[Michael Trick's website (which
        contains the world records too)].

[[_travelingtournamentproblemsize]]
==== Problem Size
...
[[_cheaptimeschedulingproblemdescription]]
==== Problem Description
...
The problem is defined by http://iconchallenge.insight-centre.org/[the ICON
        challenge].

[[_cheaptimeschedulingproblemsize]]
==== Problem Size
