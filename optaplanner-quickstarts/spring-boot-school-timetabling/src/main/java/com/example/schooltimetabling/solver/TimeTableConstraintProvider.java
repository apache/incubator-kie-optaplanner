...
public class TimeTableConstraintProvider implements ConstraintProvider {
    ...
    protected Constraint teacherRoomStability(ConstraintFactory constraintFactory) {
    ...
    protected Constraint teacherTimeEfficiency(ConstraintFactory constraintFactory) {
    ...
    protected Constraint studentGroupSubjectVariety(ConstraintFactory constraintFactory) {
