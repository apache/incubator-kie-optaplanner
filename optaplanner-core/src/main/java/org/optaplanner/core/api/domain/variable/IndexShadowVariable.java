...
/**
 * Specifies that a bean property (or a field) is the index of this class's instance that is an item in
 * a {@link CollectionPlanningVariable}, which implies it's a shadow variable.
 * <p>
