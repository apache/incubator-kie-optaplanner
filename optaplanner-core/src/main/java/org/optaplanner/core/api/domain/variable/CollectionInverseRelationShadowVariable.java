...
/**
 * Specifies that a bean property (or a field) is the inverse of a {@link CollectionPlanningVariable}, which implies
...
@Target({ METHOD, FIELD })
@Retention(RUNTIME)
public @interface CollectionInverseRelationShadowVariable {
