 ...
 * algorithms. Unlike {@link PlanningVariable}, the {@link PlanningCollectionVariable} tells OptaPlanner to change
 * elements inside the collection variable instead of changing which collection is assigned to the variable.
 * <p>
