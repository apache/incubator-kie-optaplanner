...
final class BiGroupBy2Map0CollectMutator<A, B, NewA, NewB> extends AbstractBiGroupByMutator {
    ...
    public AbstractRuleAssembler apply(AbstractRuleAssembler ruleAssembler) {
        ...
        return new BiRuleAssembler(biRuleAssembler.leftHandSide.groupBy(groupKeyMappingA, groupKeyMappingB));
    }
}
