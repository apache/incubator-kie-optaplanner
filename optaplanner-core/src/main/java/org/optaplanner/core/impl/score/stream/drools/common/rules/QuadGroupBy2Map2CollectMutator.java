...
final class QuadGroupBy2Map2CollectMutator<A, B, C, D, NewA, NewB, NewC, NewD> extends AbstractQuadGroupByMutator {
    ...
    public AbstractRuleAssembler apply(AbstractRuleAssembler ruleAssembler) {
        ...
        return new QuadRuleAssembler(quadRuleAssembler.leftHandSide.groupBy(groupKeyMappingA, groupKeyMappingB,
                new DroolsQuadAccumulateFunction<>(collectorC), new DroolsQuadAccumulateFunction<>(collectorD)));
    }
}
