...
public class KOptMoveSelectorFactory<Solution_>
        extends AbstractMoveSelectorFactory<Solution_, KOptMoveSelectorConfig<Solution_>> {

    private static final int K = 3;

    public KOptMoveSelectorFactory(KOptMoveSelectorConfig<Solution_> moveSelectorConfig) {
