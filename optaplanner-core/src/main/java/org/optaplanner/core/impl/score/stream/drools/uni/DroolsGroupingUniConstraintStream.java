...
public final class DroolsGroupingUniConstraintStream<Solution_, A, GroupKey_>
     ...
     * the old rule, while only generating the rule ID on-demand to maintain the requirement of rule IDs being in a
     * unbroken sequence.
     ...
     * The later execution(s) of the condition from {@link DroolsAbstractUniConstraintStream#createCondition()} would
