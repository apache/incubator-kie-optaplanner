 ...
 */
public class BestSolutionListenerSupport<Solution_> extends AbstractEventSupport<BestSolutionListener<Solution_>> {

    private final Solver<Solution_> solver;

    public BestSolutionListenerSupport(Solver<Solution_> solver) {
        this.solver = solver;
    }
