...
final class UniGroupBy2Map2CollectMutator<A, NewA, NewB, NewC, NewD> extends AbstractUniGroupByMutator {
    ...
    public AbstractRuleAssembler apply(AbstractRuleAssembler ruleAssembler) {
        ...
        return new QuadRuleAssembler(uniRuleAssembler.leftHandSide.groupBy(groupKeyMappingA, groupKeyMappingB,
                new DroolsUniAccumulateFunction<>(collectorC), new DroolsUniAccumulateFunction<>(collectorD)));
    }
}
