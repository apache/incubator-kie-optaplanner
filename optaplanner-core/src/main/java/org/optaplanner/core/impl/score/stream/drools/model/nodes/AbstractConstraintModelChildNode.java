...
public abstract class AbstractConstraintModelChildNode
    ...
    private final List<ConstraintModelNode> parentNodeList = new ArrayList<>(0);

    AbstractConstraintModelChildNode(ConstraintModelNodeType type) {
        super(type);
    }

    public final void addParentNode(ConstraintModelNode node) {
    ...
    @Override
    public final List<ConstraintModelNode> getParentNodes() {
