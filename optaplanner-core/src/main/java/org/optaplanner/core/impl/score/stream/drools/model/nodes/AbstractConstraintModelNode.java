...
public abstract class AbstractConstraintModelNode implements ConstraintModelNode {

    private final List<ConstraintModelNode> childNodeList = new ArrayList<>(0);
    private final List<ConstraintConsequence> consequenceList = new ArrayList<>(0);
    private final ConstraintModelNodeType type;

    AbstractConstraintModelNode(ConstraintModelNodeType type) {
        this.type = Objects.requireNonNull(type);
    }

    public final void addChildNode(ConstraintModelNode node) {
        ConstraintModelNode nonNullNode = requireNonNull(node);
    ...
    @Override
    public final List<ConstraintModelNode> getChildNodes() {
    ...
    public final ConstraintModelNodeType getType() {
        return type;
    }
}
