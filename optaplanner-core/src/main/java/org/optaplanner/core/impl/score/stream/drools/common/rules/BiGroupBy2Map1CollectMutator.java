...
final class BiGroupBy2Map1CollectMutator<A, B, NewA, NewB, NewC> extends AbstractBiGroupByMutator {
    ...
    public AbstractRuleAssembler apply(AbstractRuleAssembler ruleAssembler) {
        ...
        return new TriRuleAssembler(biRuleAssembler.leftHandSide.groupBy(groupKeyMappingA, groupKeyMappingB,
                new DroolsBiAccumulateFunction<>(collectorC)));
    }
}
