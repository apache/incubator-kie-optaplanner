...
public interface ConstraintConsequence<Node_ extends ConstraintModelNode> {
    ...
    static <A> UniConstraintConsequence<A> create(UniConstraintModelNode<A> terminalNode,
    ...
    static <A, B> BiConstraintConsequence<A, B> create(BiConstraintModelNode<A, B> terminalNode,
    ...
    static <A, B, C> TriConstraintConsequence<A, B, C> create(TriConstraintModelNode<A, B, C> terminalNode,
