...
public class EntityTabuAcceptorTest {
    ...
    public void tabuSize() {
        ...
        assertThat(acceptor.isAccepted(buildMoveScope(stepScope0, e2))).isTrue(); // repeated call
        ...
        assertThat(acceptor.isAccepted(buildMoveScope(stepScope1, e2))).isTrue(); // repeated call
        ...
        assertThat(acceptor.isAccepted(buildMoveScope(stepScope2, e2))).isFalse(); // repeated call
        ...
        assertThat(acceptor.isAccepted(buildMoveScope(stepScope3, e2))).isFalse(); // repeated call
        ...
        assertThat(acceptor.isAccepted(buildMoveScope(stepScope4, e2))).isTrue(); // repeated call
