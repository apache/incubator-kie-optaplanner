...
public class SimulatedAnnealingAcceptorTest extends AbstractAcceptorTest {
    ...
    public void lateAcceptanceSize() {
        ...
        assertThat(acceptor.isAccepted(buildMoveScope(stepScope0, -1300))).isEqualTo(false);
        when(workingRandom.nextDouble()).thenReturn(0.3);
        assertThat(acceptor.isAccepted(buildMoveScope(stepScope0, -1200))).isEqualTo(true);
        when(workingRandom.nextDouble()).thenReturn(0.4);
        assertThat(acceptor.isAccepted(buildMoveScope(stepScope0, -1200))).isEqualTo(false);
        ...
        assertThat(acceptor.isAccepted(buildMoveScope(stepScope1, -700))).isEqualTo(true);
        ...
        assertThat(acceptor.isAccepted(buildMoveScope(stepScope2, -800))).isEqualTo(true);
        when(workingRandom.nextDouble()).thenReturn(0.01);
        assertThat(acceptor.isAccepted(buildMoveScope(stepScope2, -801))).isEqualTo(false);
        when(workingRandom.nextDouble()).thenReturn(0.01);
        assertThat(acceptor.isAccepted(buildMoveScope(stepScope2, -1200))).isEqualTo(false);
