...
public class SubChainChangeMoveTest {
    ...
    public void sameChainWithOneBetween() {
        ...
        SubChainChangeMove move = new SubChainChangeMove(
    ...
    public void toStringTest() {
        ...
        assertThat(new SubChainChangeMove(new SubChain(Arrays.<Object>asList(a2, a3, a4)),
                variableDescriptor, inverseVariableSupply, b0).toString()).isEqualTo("[a2..a4] {a1 -> b0}");
        assertThat(new SubChainChangeMove(new SubChain(Arrays.<Object>asList(a1, a2, a3, a4, a5)),
                variableDescriptor, inverseVariableSupply, b3).toString()).isEqualTo("[a1..a5] {a0 -> b3}");
        assertThat(new SubChainChangeMove(new SubChain(Arrays.<Object>asList(a1, a2, a3)),
                variableDescriptor, inverseVariableSupply, a5).toString()).isEqualTo("[a1..a3] {a0 -> a5}");
        assertThat(new SubChainChangeMove(new SubChain(Arrays.<Object>asList(a3)),
                variableDescriptor, inverseVariableSupply, b2).toString()).isEqualTo("[a3..a3] {a2 -> b2}");
    }
