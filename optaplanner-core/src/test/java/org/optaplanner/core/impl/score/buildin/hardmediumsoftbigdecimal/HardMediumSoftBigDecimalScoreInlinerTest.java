...
public class HardMediumSoftBigDecimalScoreInlinerTest {
    ...
    public void buildWeightedScoreImpacter() {
        ...
        assertEquals(HardMediumSoftBigDecimalScore.of(new BigDecimal("90.0"), BigDecimal.ZERO, BigDecimal.ZERO),
        ...
        assertEquals(HardMediumSoftBigDecimalScore.of(new BigDecimal("890.0"), BigDecimal.ZERO, BigDecimal.ZERO),
                scoreInliner.extractScore(0));
        hardUndo.undoScoreImpact();
        assertEquals(HardMediumSoftBigDecimalScore.of(new BigDecimal("800.0"), BigDecimal.ZERO, BigDecimal.ZERO),
                scoreInliner.extractScore(0));
        ...
        assertEquals(HardMediumSoftBigDecimalScore.of(new BigDecimal("800.0"), new BigDecimal("7.0"), BigDecimal.ZERO),
                scoreInliner.extractScore(0));
        ...
        assertEquals(HardMediumSoftBigDecimalScore.of(new BigDecimal("800.0"), BigDecimal.ZERO, new BigDecimal("3.0")),
                scoreInliner.extractScore(0));
        softImpacter.impactScore(new BigDecimal("10.0"), scoreConsumer);
        assertEquals(HardMediumSoftBigDecimalScore.of(new BigDecimal("800.0"), BigDecimal.ZERO, new BigDecimal("13.0")),
                scoreInliner.extractScore(0));
        softUndo.undoScoreImpact();
        assertEquals(HardMediumSoftBigDecimalScore.of(new BigDecimal("800.0"), BigDecimal.ZERO, new BigDecimal("10.0")),
                scoreInliner.extractScore(0));
